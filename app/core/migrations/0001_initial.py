# Generated by Django 4.1.13 on 2023-12-14 16:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', django.contrib.postgres.fields.ArrayField(base_field=models.FloatField(), default=list, size=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('text', models.TextField()),
                ('username', models.TextField(default='Anonimo')),
                ('is_username_visible', models.BooleanField(default=True)),
